    ...
    <footer className="py-10 bg-slate-900 text-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold text-blue-400 mb-4">Ilham Izzul Hadyan</h3>
            <p className="text-slate-300">
              QA & Fullstack Developer specializing in automation testing and quality assurance solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#certifications" className="text-slate-300 hover:text-blue-400 transition-colors">Certifications</a></li>
